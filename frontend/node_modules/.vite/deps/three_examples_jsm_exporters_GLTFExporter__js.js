import { BufferAttribute, ClampToEdgeWrapping, Color, CompressedTexture, InterpolateLinear, LinearFilter, LinearMipmapLinearFilter, LinearMipmapNearestFilter, MathUtils, Matrix4, Mesh, MirroredRepeatWrapping, NearestFilter, NearestMipmapLinearFilter, NearestMipmapNearestFilter, PerspectiveCamera, PlaneGeometry, PropertyBinding, Quaternion, RepeatWrapping, SRGBColorSpace, Scene, ShaderMaterial, Source, Texture, Uniform, Vector3, WebGLRenderer } from "./three.js";
//#region node_modules/three/examples/jsm/utils/TextureUtils.js
var _renderer;
...
var GLTFWriter = class {
	...
	*/
	processBufferView(attribute, componentType, start, count, target) {
		...
		if (target === WEBGL_CONSTANTS.ARRAY_BUFFER) bufferViewDef.byteStride = attribute.itemSize * componentSize;
	...
	*/
	processImage(image, format, flipY, mimeType = "image/png") {
		if (image !== null) {
			...
			else pending.push(getToBlobPromise(canvas, mimeType).then((blob) => new FileReader().readAsDataURL(blob)).then((dataURL) => {
